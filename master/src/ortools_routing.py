...
LOCAL_SEARCH_METHODS = {
    "GD": routing_enums_pb2.LocalSearchMetaheuristic.GREEDY_DESCENT,
    ...
    "GTS": routing_enums_pb2.LocalSearchMetaheuristic.GENERIC_TABU_SEARCH,
}

class RoutingSolver:
    def __init__(self, timeout: float = 1.0, local_search: str = "GLS") -> None:
        self.timeout: float = timeout  # seconds
        self.local_search: str = local_search
    ...
    def solve(self, inst: Instance) -> Solution:
        ...
        params.local_search_metaheuristic = LOCAL_SEARCH_METHODS.get(
            self.local_search, 
